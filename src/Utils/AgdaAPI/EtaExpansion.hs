------------------------------------------------------------------------------
-- |
-- Module      : Utils.AgdaAPI.EtaExpansion
...
module Utils.AgdaAPI.EtaExpansion ( EtaExpandible(etaExpand) ) where
...
import Utils.AgdaAPI.DeBruijn      ( IncIndex(incIndex) )
import Utils.AgdaAPI.IgnoreSharing ( IgnoreSharing(ignoreSharing) )
import Utils.AgdaAPI.Interface     ( isProjection, qNameType )
